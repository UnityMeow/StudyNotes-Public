...
bool MeowApp::InitWindow(HINSTANCE hInstance, int nShowCmd)
{
	//窗口初始化描述结构体(WNDCLASS)
	WNDCLASS wc;
...
void MeowApp::CreateFence()
{
	ThrowIfFailed(d3dDevice->CreateFence(0, D3D12_FENCE_FLAG_NONE, IID_PPV_ARGS(&fence)));
}

void MeowApp::GetDescriptorSize()
{
	// 渲染目标缓冲区描述符
...
void MeowApp::CreateCommandObject()
{
	// 初始化命令描述符
...
void MeowApp::CreateViewPortAndScissorRect()
{
	// 视口设置
	viewPort.TopLeftX = 0;
	viewPort.TopLeftY = 0;
...
void  MeowApp::CalculateFrameState()
{
